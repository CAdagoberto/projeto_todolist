        ...
        <div className={styles.container}>
            <div className={styles.caixa}>
                ...
                <form className={styles.caixa_input} onSubmit={handleSubmit}>
                    <Input classeInput={styles.inputs} type="text" place="Digite seu Nome" name="name"/>
                    <Input classeInput={styles.inputs} type="text" place="Digite seu telefone" name="telefone"/>
                    ...
                    <Button classe={styles.button_login} type="submit" text="Registrar-se" />
                </form>
            </div>
        </div>
    );
